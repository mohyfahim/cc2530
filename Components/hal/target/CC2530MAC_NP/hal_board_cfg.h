/**************************************************************************************************
  ...
  Revised:        $Date: 2015-02-19 11:57:42 -0800 (Thu, 19 Feb 2015) $
...
#ifdef HAL_PA_LNA_SE2431L_SINGLE_PIN_DRIVE
#define HAL_BOARD_ENABLE_PA_LNA() st                                      \
( 															   \
  /* Set PA/LNA ENABLE control P1_1 */							\
  P1DIR |= BV(1); 								               \
)
#else
#define HAL_BOARD_ENABLE_PA_LNA()
#endif
