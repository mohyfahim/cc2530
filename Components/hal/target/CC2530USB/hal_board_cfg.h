/**************************************************************************************************
  ...
  Revised:        $Date: 2015-02-10 17:56:55 -0800 (Tue, 10 Feb 2015) $
  Revision:       $Revision: 42490 $
...
/* ----------- IEEE Address ---------- */
# define MAC_READ_CHIP_IEEE_ADDR(pBuf) \
  st \
  ( \
    uint8 *pIeeeAddr = (uint8 *) (P_INFOPAGE+HAL_INFOP_IEEE_OSET); \
    (void)osal_memcpy((pBuf), pIeeeAddr, SADDR_EXT_LEN); \
  )
