/**************************************************************************************************
  Filename:       macwrapper.h
  Revised:        $Date: 2014-10-03 18:57:39 -0700 (Fri, 03 Oct 2014) $
  Revision:       $Revision: 40423 $
...
#include "hal_types.h"
   ...
   *                             is newly created.
   */
  extern unsigned char macWrapperAddDevice(unsigned short panId, unsigned short shortAddr,
   ...
   */
  extern unsigned char macWrapperDeleteDevice(const unsigned char *extAddr);
