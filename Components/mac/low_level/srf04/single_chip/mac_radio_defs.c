/**************************************************************************************************
  ...
  Revised:        $Date: 2015-03-05 17:58:36 -0800 (Thu, 05 Mar 2015) $
  Revision:       $Revision: 43108 $
...
const uint8 CODE macRadioDefsTxPwrCC2592[] =
{
  ...
  (uint8)(int8)7, /* transmit power level of the last entry */
  /*  21 dBm */   0xF5,   /* characterized as 21.2 dBm in datasheet */
  /*  20 dBm */   0xE5,   /* characterized as 20 dBm in datasheet */
  /*  19 dBm */   0xC5,   /* characterized as 19.4 dBm in datasheet */
  /*  18 dBm */   0xB5,   /* characterized as 18.7 dBm in datasheet */
  /*  17 dBm */   0xA5,   /* characterized as 17.8 dBm in datasheet */
  /*  16 dBm */   0x95,   /* characterized as 16.7 dBm in datasheet */
  /*  15 dBm */   0x85,   /* characterized as 15.8 dBm in datasheet */
  /*  14 dBm */   0x75,   /* characterized as 14.7 dBm in datasheet */
  /*  13 dBm */   0x65,   /* characterized as 13.2 dBm in datasheet */
  /*  12 dBm */   0x65,   
  /*  11 dBm */   0x55,   /* characterized as 11.4 dBm in datasheet */
  /*  10 dBm */   0x55,   
  /*  9 dBm */    0x45,   /* characterized as 9.4 dBm in datasheet */
  /*  8 dBm  */   0x45,   
  /*  7 dBm  */   0x35,   /* characterized as 7.3 dBm in datasheet */
};
#endif
